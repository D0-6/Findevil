"""
bench.py — Find Evil Hackathon Benchmark Engine
Updated mock findings cover all 25 tools in mcp_server.py.
Run: python bench.py --image /cases/win10.E01 --ground-truth /cases/gt.json
"""
